...
def frequency_plot(fdist, filename='frequency-distribution',ax=None):
    fig = plt.figure()
    ...
    ax.set_xticklabels(map(format,labels),rotation='vertical')
    ax.set_ylabel(format('No. of times word occurred'))
    if ax is not None:
        plt.tight_layout()
